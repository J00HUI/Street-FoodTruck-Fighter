...
export const useKakaoStore = defineStore("Kakao", {
  state: () => {
    ...
    const surveyData = [
      ...
      {address:"집", category:"waffle", latitude: 36.387704400721304, longtitudes: 127.34926257984003},
      {address:"집", category:"waffle", latitude: 36.379838042140285, longtitudes: 127.37570687933562},
